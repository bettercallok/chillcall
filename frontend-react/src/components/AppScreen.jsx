...
export function AppScreen() {
    const { roomId, localStreamRef, remoteStreams, publishData } = useCall();
    ...
    useEffect(() => {
        const handleMessage = (e) => {
            try {
                const msg = e.detail;
                // Avoid processing own messages or loops (simple check if we have ID)
    ...
    const handleBroadcastMedia = (url) => {
        ...
        // Avoid self-loop if peer reflects (though data channel usually doesn't reflect back to sender)
